...
Sonar Cloud в бесплатной версии не анализирует больше одной ветки. <br>
Sonar Cloud ветки main: [Sonar](https://sonarcloud.io/project/overview?id=fxynix_LearningManagementSystem)
